<div>
    ...
    <div wire:ignore.self>
        <x-modaladd  title="اضافة حي جديدة " name="add-hood-modal">
            @slot('body')
            <form>
                ...
                <div class="items-center p-4 border-gray-200 rounded-b dark:border-gray-700">
                    ...
                    <button type="button" wire:click.prevent='storeHoodData'
    ...
    <div wire:ignor.self>
        <x-modaladd title="تعديل بيانات الحي" name="edit-hood-modal">
            <x-slot:body>
                <form>
                    <div class="p-2 space-y-6">
                    ...
                    <div class="items-center p-4 border-gray-200 rounded-b dark:border-gray-700">
                        ...
                        <button type="button" wire:click.prevent='editHoodData'
                            class="font-medium text-white btn bg-primary hover:bg-primary-focus focus:bg-primary-focus active:bg-primary-focus/90 dark:bg-accent dark:hover:bg-accent-focus dark:focus:bg-accent-focus dark:active:bg-accent/90">
                            تأكيد
                        </button>
                    </div>
    ...
    <x-modaldel wire:ignore.self name="del-hood-modal">
        @slot('delbody')
        <div class="mt-4">
            ...
            <button wire:click="deleteHoodData"
