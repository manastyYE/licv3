        ...
        <x-modaladd title="  عرض الملفات المرفقة" name="show-org-files">
            ...
            <div class="card  lg:p-6">
                ...
                <div class="mt-5 flex space-x-3 space-x-reverse">
                    <button
                        class="btn space-x-2 space-x-reverse rounded-full border border-slate-300 px-4 text-xs+ font-medium text-slate-700 hover:bg-slate-150 focus:bg-slate-150 active:bg-slate-150/80 dark:border-navy-450 dark:text-navy-100 dark:hover:bg-navy-500 dark:focus:bg-navy-500 dark:active:bg-navy-500/90">
