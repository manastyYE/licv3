            ...
            <div class="p-4 sm:p-5">
                <div class="flex flex-col">
                    ...
                    <div class="avatar mt-1.5 h-20 w-20">
                        <img class="mask is-squircle" src="{{ asset($admin->admin_img) }}"  alt="avatar" />
                        <div
                ...
                <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                    <label class="block">
                        ...
                        <span class="relative mt-1.5 flex">
                            <input
                                ...
                                placeholder="اكتب الاسم الكامل " type="text" />
                            <span
                    ...
                    <label class="block">
                        ...
                        <span class="relative mt-1.5 flex">
                            <input
                                class="form-input peer w-full rounded-full border border-slate-300 bg-transparent px-3 py-2 pr-9 placeholder:text-slate-400/70 hover:border-slate-400 focus:border-primary dark:border-navy-450 dark:hover:border-navy-400 dark:focus:border-accent"
                                placeholder=" اكتب اسم المستخدم هنا " type="text" />
                            <span
                                class="pointer-events-none absolute flex h-full w-10 items-center justify-center text-slate-400 peer-focus:text-primary dark:text-navy-300 dark:peer-focus:text-accent">
                                <i class="fa-regular fa-user text-base"></i>
                            </span>
                    ...
                    <label class="block">
                        ...
                        <span class="relative mt-1.5 flex">
                            <input
                                class="form-input peer w-full rounded-full border border-slate-300 bg-transparent px-3 py-2 pr-9 placeholder:text-slate-400/70 hover:border-slate-400 focus:border-primary dark:border-navy-450 dark:hover:border-navy-400 dark:focus:border-accent"
                                placeholder="اكتب رقم الهاتف" type="text" />
                            <span
                                class="pointer-events-none absolute flex h-full w-10 items-center justify-center text-slate-400 peer-focus:text-primary dark:text-navy-300 dark:peer-focus:text-accent">
