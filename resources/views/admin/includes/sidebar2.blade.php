        ...
        <div
            ...
            <div x-data="{ condition: '{{ $name }}' }" class="is-scrollbar-hidden flex grow flex-col space-y-4 overflow-y-auto pt-6">
                ...
                <a href="{{ route('dashboard') }}"
                    x-bind:class="condition == 'dashboard' ? 'bg-primary/10 text-primary' : ''"
                ...
                <a href="{{ route('orgs.show') }}"
                    x-bind:class="condition == 'orgs' ? 'bg-primary/10 text-primary' : ''"
                    class="flex h-11 w-11 items-center justify-center rounded-lg outline-none transition-colors duration-200 hover:bg-primary/20 focus:bg-primary/20 active:bg-primary/25 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25"
                ...
                <a href="{{ route('org_type') }}"
                    x-bind:class="condition == 'org_type' ? 'bg-primary/10 text-primary' : ''"
                ...
                <!-- Components -->
                <a href="/admin/streets" x-bind:class="condition == 'street' ? 'bg-primary/10 text-primary' : ''"
                    class="flex h-11 w-11 items-center justify-center rounded-lg outline-none transition-colors duration-200 hover:bg-primary/20 focus:bg-primary/20 active:bg-primary/25 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25"
